...
public class DynamicLineChartManager {
    ...
    //一条曲线
    public DynamicLineChartManager(LineChart mLineChart, String name, int color,ArrayList<String> timeList) {
...
//        lineChart.getXAxis().setLabelCount(20);
        //显示边界
        ...
        xAxis.setGranularity(1f);
        xAxis.setLabelRotationAngle(8f);
     ...
     * @param xzhou
     */
    public void addEntrys(List<Integer> numbers,List<String> xzhou) {
...
//        timeList.add(df.format(System.currentTimeMillis()));
    ...
    public void addEntrys(List<Integer> numbers) {
...
//        timeList = xzhou;
    ...
    public void setxValue(ArrayList<String> liststr){
