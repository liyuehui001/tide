...
/**
 * Created by xupeizuo on 2016/5/9.
 * Gson数据转化处理
 */
public final class GsonHelper {
     ...
     * @return 实体
     */
    public static <T> T convertEntity1(String jsonData, Class<T> entityClass) throws JsonSyntaxException{
        T entity = sGson.fromJson(jsonData.toString(), entityClass);
        return entity;
    }
     ...
     * @return 实体列表
     */
    public static <T> ArrayList<T> convertEntities(String jsonData, Class<T> entityClass) {
