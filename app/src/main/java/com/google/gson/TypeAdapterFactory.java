 ...
 *       Class<ToastUtil> rawType = (Class<ToastUtil>) type.getRawType();
 *       if (!rawType.isEnum()) {
 *         return null;
 *       }
 *
 *       final Map<String, ToastUtil> lowercaseToConstant = new HashMap<String, ToastUtil>();
 *       for (ToastUtil constant : rawType.getEnumConstants()) {
 ...
 *         }
 *
 *         public ToastUtil read(JsonReader reader) throws IOException {
 ...
 *     public <ToastUtil> TypeAdapter<ToastUtil> create(Gson gson, TypeToken<ToastUtil> typeToken) {
 ...
 *       return (TypeAdapter<ToastUtil>) newMultisetAdapter(elementAdapter);
 *     }
 *
